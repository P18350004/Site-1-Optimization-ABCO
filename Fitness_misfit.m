...
% Import sample data
load('lambda_curve0.mat') %wavelengths of fundamental mode dispersion curve
load('c_curve0.mat')      % Rayleigh wave phase velocities of fundamental mode disperison curve  

%% inversion

c_test_min = 0; % m/s     %minimum Rayleigh wave phase velocity
c_test_max = 700; % m/s   %maximum Rayleigh wave phase velocity
delta_c_test = 5; % m/s    % smallest interval of Rayleigh wave phase velocity
c_test = c_test_min:delta_c_test:c_test_max; % m/s 

%inputs
n = 5;  % number of soil layers
alpha = [ 1000 1000 1000 1000 1000 1000]; % m/s % P-wave velocity
...
rho = [2000 2000 2000 2000 2000 2000]; % kg/m^3
